...
let init my_nid my_ndata view view_len xchg_len period
      view_ext distance send_cb recv_cb view_cb =
...
(** initiate gossip exchange with a node from [t.view],
