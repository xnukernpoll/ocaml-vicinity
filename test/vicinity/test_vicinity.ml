...
let test_xchg _ctx =
  ...
  let (nid, data, sent, _view) =
    make_exchange view get_view_rnd my_nid my_data xchg_len distance in
...
let test_recv _ctx =
  ...
  let resp =
    make_response view2 get_view_rnd my_nid my_data rnid rdata
